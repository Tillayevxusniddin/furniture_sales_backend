...
class OrderController extends Controller
{
    ...
    public function store(StoreOrderRequest $request)
    {
        ...
        if ($notFoundProducts === [] && $products !== [] && $sum !== 0) {  // if there is no product
                    /// TODO add status
            ...
            return $this->error('Products not found or not enough stock', ['not_found_products' => $notFoundProducts]);
        }


        return 'something went wrong , can\'t create order';
    }
